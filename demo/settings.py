...
MANAGERS = ADMINS
MOTOR_DB = 'mysql' #'sqlite' # configuracion del motor princial de nuestro proyecto
...
if MOTOR_DB == 'mysql':
    DATABASES = {
        'default': {
            ...
            'PASSWORD': 'isel',                  # Not used with sqlite3.
...
SECRET_KEY = '+8@1f(5xu9^lt-g)b3)bi*x^6ix48p_69q)9@67d%i37o*^o%y'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'miguel.isel17@gmail.com' #correo electronico al cual recivira los email
EMAIL_HOST_PASSWORD = 'noroyshii171513' #contraseña del correo electronico
EMAIL_USE_TLS = True
